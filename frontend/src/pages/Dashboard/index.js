...
export default ({history}) => {
  ...
  const tools = <Tools 
    tools = {[
      {
        icon: <FiFileText size={24} className={`${view === 0 ? 'red': ''} btn-icon`} />,
        className: view === 0 ? 'red ' : '',
        text: 'Pedidos',
        onClick: () => setView(0)
      },
      {
        icon: <FiDollarSign size={24} className={`${view === 1 ? 'red': ''} btn-icon`} />,
        className: view === 1 ? 'red ' : '',
        text: 'Vendas',
        onClick: () => setView(1)
      },
      {
        icon: <FiBookOpen size={24} className={`${view === 2 ? 'red': ''} btn-icon`} />,
        className: view === 2 ? 'red ' : '',
        text: 'Cardápio',
        onClick: () => setView(2)
      },
      {
        icon: <FiUser size={24} className={`${view === 3 ? 'red': ''} btn-icon`} />,
        className: view === 3 ? 'red ' : '',
        text: 'Perfil',
        onClick: () => setView(3)
      },
      {
...
/*
  const tools = <div className="tools">
    <button >
      <FiShoppingCart size={24} className='red btn-icon' />
      <span className='red' >Pedidos</span>
    </button>
      ...
      }
      {
        view === 3 ? 
          <div className="perfil">
            ...
            <div className="perfil-row" style={{ border:'none' }}>
              <div className="perfil-col">
